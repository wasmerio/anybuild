...
def test_generate_shipit_matches_example(
    ...
    # The shipit version in the header is masked so release bumps don't
    # invalidate every checked-in example.
    assert _mask_version(generated) == _mask_version(expected)


_VERSION_PATTERN = re.compile(r"^# Generated by Shipit v\S+", re.MULTILINE)


def _mask_version(shipit_text: str) -> str:
    return _VERSION_PATTERN.sub("# Generated by Shipit v<VERSION>", shipit_text)
