...
class WasmerRunner:
    ...
    mapper: Dict[str, MapperItem] = {
        ...
        "phpix": {
            "dependencies": {
                "latest": "wasmer/phpix-32@=0.1.1080321-alpha.7",
                "8.3": "wasmer/phpix-32@=0.1.1080321-alpha.7",
                "8.2": "wasmer/phpix-32@=0.1.1080321-alpha.7",
                "8.1": "wasmer/phpix-32@=0.1.1080321-alpha.7",
                "7.4": "wasmer/phpix-32@=0.1.1080321-alpha.7",
            },
            "architecture_dependencies": {
                "64-bit": {
                    "latest": "wasmer/phpix-64@=0.1.1080321-alpha.7",
                    "8.3": "wasmer/phpix-64@=0.1.1080321-alpha.7",
                    "8.2": "wasmer/phpix-64@=0.1.1080321-alpha.7",
                    "8.1": "wasmer/phpix-64@=0.1.1080321-alpha.7",
                    "7.4": "wasmer/phpix-64@=0.1.1080321-alpha.7",
                },
                "32-bit": {
                    "latest": "wasmer/phpix-32@=0.1.1080321-alpha.7",
                    "8.3": "wasmer/phpix-32@=0.1.1080321-alpha.7",
