...
pub static CASES: &[Case] = &[
    ...
    Case {
        ...
        http: &[body("/", r"Hello from Hono on Anybuild")],
        build_modes: Some(LOCAL_AND_WASMER),
        ..BASE
    },
    ...
    Case {
        ...
        http: &[body("/", r"Hello from Fastify on Anybuild")],
        build_modes: Some(LOCAL_AND_WASMER),
        ..BASE
    },
    ...
    Case {
        ...
        http: &[body("/", r"Hello from Express on Anybuild")],
        build_modes: Some(WASMER_ONLY),
        ..BASE
    },
    ...
    Case {
        ...
        http: &[body("/", r"Hello from Koa on Anybuild")],
        build_modes: Some(WASMER_ONLY),
        ..BASE
    },
    ...
    Case {
        ...
        http: &[body("/", r"Hello from H3 on Anybuild")],
        build_modes: Some(WASMER_ONLY),
        ..BASE
    },
    ...
    Case {
        ...
        http: &[body("/", r"Hello from Elysia on Anybuild")],
        build_modes: Some(WASMER_ONLY),
        ..BASE
    },
    ...
    Case {
        ...
        http: &[body("/", r"Hello from NestJS on Anybuild")],
        build_modes: Some(WASMER_ONLY),
        ..BASE
    },
    ...
    Case {
        ...
        http: &[body("/", r"Hello from Nitro on Anybuild")],
        build_modes: Some(WASMER_ONLY),
        ..BASE
    },
    ...
    Case {
        ...
        http: &[body("/", r"Hello from Hydrogen on Anybuild")],
        build_modes: Some(WASMER_ONLY),
        ..BASE
    },
    ...
    Case {
        ...
        http: &[body("/", r"Hello from React Router on Anybuild")],
        build_modes: Some(WASMER_ONLY),
        ..BASE
    },
    ...
    Case {
        ...
        http: &[body("/", r"Hello from Remix on Anybuild")],
        build_modes: Some(WASMER_ONLY),
        ..BASE
    },
    ...
    Case {
        ...
        http: &[body("/", r"Hello from SolidStart on Anybuild")],
        build_modes: Some(WASMER_ONLY),
        ..BASE
    },
    ...
    Case {
        ...
        http: &[body("/", r"Hello from XMCP on Anybuild")],
        build_modes: Some(WASMER_ONLY),
        ..BASE
    },
    ...
    Case {
        ...
        http: &[body("/", r"Hello from Mastra on Anybuild")],
        build_modes: Some(WASMER_ONLY),
        ..BASE
    },
    ...
    Case {
        ...
        http: &[body(
            "/anybuild-health.txt",
            r"Hello from Next\.js on Anybuild",
        )],
        build_modes: Some(LOCAL_AND_WASMER),
        ..BASE
    },
