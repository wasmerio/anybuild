//! Starlark module loading: label resolution and the load() graph.
//!
...
pub const STARLIB_NAMESPACE: &str = "shipit";

/// Strict superset of the previous dialect: legacy fully-inlined Shipit
...
/// Where `//shipit/...` labels resolve. `Dir` reads from a directory on
